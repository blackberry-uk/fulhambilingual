...
export const TRANSLATIONS = {
  EN: {
    ...
    nav_wix_petition: "Wix Petition",
    site_name: "FB COMMUNITY",
    full_name: "Full Name",
    email: "Email Address",
    ...
    signatures_so_far: "Signatures so far",
    back_to_petition: "Back to Petition",
    back_to_home: "Back to Home",
    back_to_site: "Back to Site",
    registered_success: "Registered.",
    thank_you_message: "Thank you for joining the community voice. We are stronger together.",
    coming_soon: "Coming Soon",
    testimonials_title: "Personal Experience",
    testimonials_subtitle: "Stories of impact from our families and alumni.",
    signatories_title: "Signatories",
    signatories_subtitle: "A growing list of community supporters.",
    alumni_subtitle: "Direct from our graduates",
    alumni_subtitle_alt: "Hear from the students",
    read_the_petition: "Read the Petition",
    manage_signature: "Manage my signature",
    view_testimonial: "Read Testimonial",
    edit_success: "Your signature has been updated successfully.",
    request_code_title: "Edit your signature",
    request_code_intro: "Enter your email address and we'll send you a 6-digit access code to edit your signature and preferences.",
    enter_code_title: "Enter Access Code",
    enter_code_intro: "Please enter the 6-digit code sent to your email.",
    request_button: "Send Code",
    verify_button: "Verify Code",
    resend_code: "Didn't receive a code? Resend",
    code_placeholder: "XXXXXX",
    petition_title: "Future of The Fulham Bilingual Partnership",
    home_subtitle: "Future of The Fulham Bilingual Partnership",
    petition_body: `To:
...
Parents, families, alumni, and supporters of Fulham Bilingual School`,
  ...
  FR: {
    ...
    nav_wix_petition: "Pétition Wix",
    site_name: "COMMUNAUTÉ FB",
    ...
    signatures_so_far: "Signatures à ce jour",
    back_to_petition: "Retour à la pétition",
    back_to_home: "Retour à l'accueil",
    back_to_site: "Retour au site",
    registered_success: "Inscrit.",
    thank_you_message: "Merci d'avoir rejoint la voix de la communauté. Nous sommes plus forts ensemble.",
    coming_soon: "Bientôt disponible",
    testimonials_title: "Expériences Personnelles",
    testimonials_subtitle: "Témoignages de nos familles et anciens élèves.",
    signatories_title: "Signataires",
    signatories_subtitle: "Une liste croissante de soutiens de la communauté.",
    alumni_subtitle: "Paroles de nos diplômés",
    alumni_subtitle_alt: "Paroles de nos élèves",
    read_the_petition: "Lire la pétition",
    manage_signature: "Gérer ma signature",
    view_testimonial: "Lire le témoignage",
    edit_success: "Votre signature a été mise à jour avec succès.",
    request_code_title: "Modifier votre signature",
    request_code_intro: "Entrez votre adresse e-mail et nous vous enverrons un code d'accès à 6 chiffres pour modifier votre signature et vos préférences.",
    enter_code_title: "Entrez le code d'accès",
    enter_code_intro: "Veuillez saisir le code à 6 chiffres envoyé à votre adresse e-mail.",
    request_button: "Envoyer le code",
    ...
    home_subtitle: "Avenir du Partenariat Fulham Bilingual",
